...
const configureClient = async () => {
  ...
  auth0 = await createAuth0Client({
    ...
    //organization: 'org_gxWoWHB5340rW5jb', // this is org2 'org_si4nEpR6vSerzw09',
    cacheLocation: 'localstorage',
    scope: 'openid email profilei offline_access read:reports write:reports admin:reports',
...
function parseJwt (token) {
  ...
  console.log("Access token: " + jsonPayload);
